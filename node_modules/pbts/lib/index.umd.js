(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.pbToTypescript = {}, global.protobuf));
}(this, (function (exports, protobuf) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function _getAllMethods(root) {
        var service = root.nestedArray.find(function (s) { return s instanceof protobuf.Service; });
        var firstService = root.lookupService(service.name);
        return firstService.methods;
    }
    function getAllMethods(source) {
        var res = protobuf__default['default'].parse(source, {
            keepCase: true,
    ...
    function mockType(root, typeName) {
        ...
        var fieldMock = type.fieldsArray &&
            type.fieldsArray.reduce(function (a, b) {
                ...
                if (b instanceof protobuf.MapField) {
    ...
    function parseProto(source, _options) {
        ...
        var res = protobuf__default['default'].parse(source, { keepCase: true });
    ...
    exports.printTypescript = printTypescript;
