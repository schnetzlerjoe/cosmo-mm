...
Cosmos.prototype.sign = function(stdSignMsg, ecpairPriv) {
...
Cosmos.prototype.broadcast = function(signedTx, modeType = "BROADCAST_MODE_SYNC") {
	let broadcastApi = "/cosmos/tx/v1beta1/txs";

	let buf = encode.toBase64(JSON.stringify(signedTx));
