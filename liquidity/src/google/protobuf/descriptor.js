...
export const FileDescriptorSet = {
    ...
    fromJSON(object) {
        const message = { ...baseFileDescriptorSet };
        message.file = (object.file ?? []).map((e) => FileDescriptorProto.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        ...
        message.package =
            object.package !== undefined && object.package !== null
                ...
                : "";
        message.dependency = (object.dependency ?? []).map((e) => String(e));
        message.publicDependency = (object.publicDependency ?? []).map((e) => Number(e));
        message.weakDependency = (object.weakDependency ?? []).map((e) => Number(e));
        message.messageType = (object.messageType ?? []).map((e) => DescriptorProto.fromJSON(e));
        message.enumType = (object.enumType ?? []).map((e) => EnumDescriptorProto.fromJSON(e));
        message.service = (object.service ?? []).map((e) => ServiceDescriptorProto.fromJSON(e));
        message.extension = (object.extension ?? []).map((e) => FieldDescriptorProto.fromJSON(e));
        message.options =
    ...
    fromJSON(object) {
        ...
        message.name =
            object.name !== undefined && object.name !== null
                ? String(object.name)
                : "";
        message.field = (object.field ?? []).map((e) => FieldDescriptorProto.fromJSON(e));
        message.extension = (object.extension ?? []).map((e) => FieldDescriptorProto.fromJSON(e));
        message.nestedType = (object.nestedType ?? []).map((e) => DescriptorProto.fromJSON(e));
        message.enumType = (object.enumType ?? []).map((e) => EnumDescriptorProto.fromJSON(e));
        message.extensionRange = (object.extensionRange ?? []).map((e) => DescriptorProto_ExtensionRange.fromJSON(e));
        message.oneofDecl = (object.oneofDecl ?? []).map((e) => OneofDescriptorProto.fromJSON(e));
        message.options =
            object.options !== undefined && object.options !== null
                ? MessageOptions.fromJSON(object.options)
                : undefined;
        message.reservedRange = (object.reservedRange ?? []).map((e) => DescriptorProto_ReservedRange.fromJSON(e));
        message.reservedName = (object.reservedName ?? []).map((e) => String(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
...
export const ExtensionRangeOptions = {
    ...
    fromJSON(object) {
        const message = { ...baseExtensionRangeOptions };
        message.uninterpretedOption = (object.uninterpretedOption ?? []).map((e) => UninterpretedOption.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        ...
        message.name =
            object.name !== undefined && object.name !== null
                ? String(object.name)
                : "";
        message.value = (object.value ?? []).map((e) => EnumValueDescriptorProto.fromJSON(e));
        message.options =
            object.options !== undefined && object.options !== null
                ? EnumOptions.fromJSON(object.options)
                : undefined;
        message.reservedRange = (object.reservedRange ?? []).map((e) => EnumDescriptorProto_EnumReservedRange.fromJSON(e));
        message.reservedName = (object.reservedName ?? []).map((e) => String(e));
        return message;
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        ...
        message.name =
            object.name !== undefined && object.name !== null
                ? String(object.name)
                : "";
        message.method = (object.method ?? []).map((e) => MethodDescriptorProto.fromJSON(e));
        message.options =
            object.options !== undefined && object.options !== null
...
export const UninterpretedOption = {
    ...
    fromJSON(object) {
        const message = { ...baseUninterpretedOption };
        message.name = (object.name ?? []).map((e) => UninterpretedOption_NamePart.fromJSON(e));
...
export const SourceCodeInfo = {
    ...
    fromJSON(object) {
        const message = { ...baseSourceCodeInfo };
        message.location = (object.location ?? []).map((e) => SourceCodeInfo_Location.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
...
export const SourceCodeInfo_Location = {
    ...
    fromJSON(object) {
        ...
        message.path = (object.path ?? []).map((e) => Number(e));
        message.span = (object.span ?? []).map((e) => Number(e));
        ...
        message.trailingComments =
            object.trailingComments !== undefined && object.trailingComments !== null
                ...
                : "";
        message.leadingDetachedComments = (object.leadingDetachedComments ?? []).map((e) => String(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
...
export const GeneratedCodeInfo = {
    ...
    fromJSON(object) {
        const message = { ...baseGeneratedCodeInfo };
        message.annotation = (object.annotation ?? []).map((e) => GeneratedCodeInfo_Annotation.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
